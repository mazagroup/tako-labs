...
import org.tako.aop.IntroductionAwareMethodMatcher;
import org.tako.aop.MethodMatcher;
import org.tako.aop.ProxyMethodInvocation;
import org.tako.aop.framework.autoproxy.ProxyCreationContext;
import org.tako.aop.interceptor.ExposeInvocationInterceptor;
import org.tako.aop.support.AbstractExpressionPointcut;
...
import org.tako.commons.util.StringUtils;

/**
 * Spring {@link org.tako.aop.Pointcut} implementation
...
/*TODO		if (this.beanFactory instanceof ConfigurableBeanFactory) {
	...
	private class BeanContextMatcher implements ContextBasedMatcher {
		...
		private FuzzyBoolean contextMatch(@Nullable Class<?> targetType) {
			throw new UnsupportedOperationException("Implement an OSGi compatible mechanism");

		}

		private boolean matchesBean(String advisedBeanName) {
			throw new UnsupportedOperationException("Require OSGi compatible mechanism");
