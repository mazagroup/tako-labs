...
public class AspectJExpressionPointcutTests {
	...
	public void testMatchExplicit() {
		String expression = "execution(int org.tako.commons.tests.sample.beans.TestBean.getAge())";
	...
	private void testThisOrTarget(String which) throws SecurityException, NoSuchMethodException {
		String matchesTestBean = which + "(org.tako.commons.tests.sample.beans.TestBean)";
		String matchesIOther = which + "(org.tako.commons.tests.sample.beans.IOther)";
	...
	private void testWithinPackage(boolean matchSubpackages) throws SecurityException, NoSuchMethodException {
		String withinBeansPackage = "within(org.tako.commons.tests.sample.beans.";
	...
	public void testMatchWithArgs() throws Exception {
		String expression = "execution(void org.tako.commons.tests.sample.beans.TestBean.setSomeNumber(Number)) && args(Double)";
...
*/
	...
	public void testWithUnsupportedPointcutPrimitive() {
		String expression = "call(int org.tako.commons.tests.sample.beans.TestBean.getAge())";
