...
public class SliceImpl<T> extends Chunk<T> {
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.domain.ISlice#hasNext()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.domain.ISlice#transform(org.springframework.core.convert.converter.Converter)
	 */
	@Override
